...
<body ng-app="dongyimai" ng-controller="itemPageController" ng-init="loadSku();num=1">
            ...
            <div class="py-container">
                <div class="shortcut">
                    ...
                    <ul class="fr">
                        ...
                        <li class="f-item"><a href="home.html" target="_blank">我的优乐选</a></li>
                        <li class="f-item space"></li>
                        <li class="f-item">优乐选会员</li>
                        <li class="f-item space"></li>
                        <li class="f-item">企业采购</li>
                        <li class="f-item space"></li>
                        <li class="f-item">关注优乐选</li>
                        <li class="f-item space"></li>
