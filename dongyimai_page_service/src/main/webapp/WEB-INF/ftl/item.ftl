                ...
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
                        ...
                        <dl>
                            ...
                            <dd>
                                <a href="javascript:;" class="{{isSelected('${spec.attributeName}','${option}')?'selected':''}}" ng-click="selectedSpecification('${spec.attributeName}','${option}')">
                                    ${option}
                    ...
                    <div class="tab-content tab-wraped">
                        <div id="one" class="tab-pane active">
                            <ul class="goods-intro unstyled">
                                ...
                                <#list customAttributeItems as item >
